...
<head>
    <meta charset="UTF-8">
    <title>志高音乐搜索器 - 多站合一音乐搜索,音乐在线试听</title>
...
<body>
    ...
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                <h2 class="about-title about-color">志高音乐搜索器</h2>
                <p class="am-text-center">多站合一音乐搜索免费下载</p>
            </header>
            <hr>
            <div class="am-u-lg-12 am-padding-vertical">
                ...
                <div class="am-u-md-12 am-u-sm-centered am-margin-vertical music-tips">
                    ...
                    <blockquote id="j-quote" class="music-overflow">
                        <p><span>网抑云：</span><u>http://music.163.com/#/song?id=<b>25906124</b></u></p>
                        <p><span>企鹅：</span><u>http://y.qq.com/n/yqq/song/<b>002B2EAA3brD5b</b>.html</u></p>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="http://tool.123456789/" target="_blank" rel="noreferrer">电脑版</a>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
